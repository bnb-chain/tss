...
./tss --home="./configs/0/" --p2p.listen="/ip4/127.0.0.1/tcp/27149" --profile_addr="127.0.0.1:6060" > client0.log 2>&1 &
sleep 5
echo "start second client"
./tss --home="./configs/1/" --p2p.listen="/ip4/127.0.0.1/tcp/27150" --profile_addr="127.0.0.1:6061" > client1.log 2>&1 &
sleep 5
echo "start third client"
./tss --home="./configs/2/" --p2p.listen="/ip4/127.0.0.1/tcp/27151" --profile_addr="127.0.0.1:6062" > client2.log 2>&1 &
