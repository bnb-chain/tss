...
/Users/zhaocong/go/src/github.com/binance-chain/node/build/tbnbcli send --amount 1000:BNB --to tbnb1mh3w2kxmdmnvctt7t5nu7hhz9jnp422edqdw2d --from party0 --chain-id Binance-Chain-Nile --node https://data-seed-pre-0-s1.binance.org:443 --trust-node > client0_sign.log 2>&1 &
sleep 5
...
/Users/zhaocong/go/src/github.com/binance-chain/node/build/tbnbcli send --amount 1000:BNB --to tbnb1mh3w2kxmdmnvctt7t5nu7hhz9jnp422edqdw2d --from party1 --chain-id Binance-Chain-Nile --node https://data-seed-pre-0-s1.binance.org:443 --trust-node > client1_sign.log 2>&1 &
